...
ARROWUP     EQU         $18         ;ARROW UP ASCII
ARROWDOWN   EQU         $0A         ;ARROW DOWN
...
INITIALISE:
	...
	;INITIALIZE HEALTH
	ADD.L   #4, HEALTH              ;SET HEALTH TO 3
...
DRAW_PLYR_DATA:
    ...
    MOVE.L  #TC_CURSR_P,D0          ; Set Cursor Position
    ...
    TRAP    #15                     ; Trap (Perform action)
    MOVE.L  #03,        D0          ; Display number at D1.L
    MOVE.W  PLAYER_SCORE,D1         ; Move Score to D1.L
    TRAP    #15                     ; Trap (Perform action)
    
    ;PLAYER HEALTH
    MOVE.L  #TC_CURSR_P,D0          ; Set Cursor Position
    MOVE.W  #$2001,     D1          ; Col 02, Row 01
    TRAP    #15                     ; Trap (Perform action)
    ...
    ; Player HEALTH Value
    MOVE.B  #TC_CURSR_P,D0          ; Set Cursor Position
    MOVE.W  #$2901,     D1          ; Col 09, Row 01
    TRAP    #15                     ; Trap (Perform action)
    MOVE.B  #03,        D0          ; Display number at D1.L
    MOVE.L  HEALTH,D1         ; Move Score to D1.L
    TRAP    #15                     ; Trap (Perform action)
...
HEALTH_MSG      DC.B    'HEALTH: ', 0       ;HEALTH STATUS MESSAGE
...
HEALTH          DS.L    01  ;RESERVE SPACE FOR HEALTH 
